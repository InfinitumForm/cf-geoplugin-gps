...
This plugin allows all **[CF Geo Plugin](https://wordpress.org/plugins/cf-geoplugin/)** users to locate their visitors using a GPS location. Using this plugin you solve the biggest problem of locating mobile visitors and correcting their location errors.

= How to use =

1. You need to have installed **[CF Geo Plugin](https://wordpress.org/plugins/cf-geoplugin/)** and legally activated Personal, Freelance or Business license.
2. You need to have activated Google Map functionality and you must place valid [Google Map API Key](https://developers.google.com/maps/documentation/javascript/get-api-key) with enabled Geocoding API.
...
Plugin in the background using GoogleGeocoding API services and CF Geo Plugin API that allow you to have the closest GPS information. Therefore, you must follow the instructions above.
...
You must know when you uninstall GPS for CF Geo Plugin you will lose complete setup, license and any other changes you have inside your WordPress installation. On uninstall we clean everything from your database that our plugin generates and you can not return that information back.
...
1. You do not have valid or proper CF Geo Plugin license
...
= GPS for CF Geo Plugin slows down my site? =
...
= 2.0.5 =
* Added support for CF Geo Plugin version 8.3.0
